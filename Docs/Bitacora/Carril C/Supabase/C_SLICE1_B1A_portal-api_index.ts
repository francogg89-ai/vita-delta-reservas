...
const CATALOG: Record<string, CatalogEntry> = {
  ...
  // A03/A04/A05/A06/A12 se agregan al cablearse (Bloque 3+), cada una con su
  // handler:'n8n', webhook, roles (D-C-39) y validate (D-C-18/40). Ej. futuro:
  //   'calendario.limpieza': { handler:'n8n', roles:['jenny','vicky','socio'],
  //                            webhook:'portal-a03-limpieza', validate: payloadVacio },
};
...
async function dispatchN8n(
  ...
  // filtrar el error interno. El message del wrapper se conserva solo si es string (los
  // wrappers usan mensajes curados —invariante a mantener en su construcción—);
  // detail:null en Slice 1 (D-C-18).
