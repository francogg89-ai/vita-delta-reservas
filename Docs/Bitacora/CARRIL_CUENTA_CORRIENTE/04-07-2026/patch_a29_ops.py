#!/usr/bin/env python3
# -*- coding: ascii -*-
# Patcher A28_OPS -> A29_OPS (portal-api). ADITIVO. Cada edicion: str_replace con
# assert count==1 (ancla unica). Al final: prueba de reversa GLOBAL (aplicar inversas
# y recuperar A28_OPS byte-identico) => garantiza que no se toco nada mas.
import sys, io

SRC = "portal-api_A28_OPS_index.ts"
DST = "portal-api_A29_OPS_index.ts"
