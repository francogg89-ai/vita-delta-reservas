-- ============================================================================
-- A26_smoke_oracle.sql  --  Carril C / Portal Operativo Interno - Bloque A
-- Oracle de GROUND TRUTH para el smoke directo de A26 (disponibilidad.cabana).
-- 100% TEST. READ-ONLY. No crea ni modifica nada (sin DDL, sin canonico).
--
-- Para que sirve:
...
-- que pongas en A26_smoke_directo.ps1 -> $CabOcup / $OcupDesde / $OcupHasta).
