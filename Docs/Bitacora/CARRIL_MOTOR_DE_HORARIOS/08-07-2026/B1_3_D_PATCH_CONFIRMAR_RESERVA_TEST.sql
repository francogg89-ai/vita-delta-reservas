...
BEGIN
  ...
  IF v_ocurr <> 1 THEN
    RAISE EXCEPTION 'D-PATCH: el anchor aparece % vez/veces (esperado 1). Abortando.', v_ocurr;
  END IF;
  ...
  -- ── Insertar el bloque ANTES del anchor (queda tras validar_disponibilidad, antes del INSERT) ──
