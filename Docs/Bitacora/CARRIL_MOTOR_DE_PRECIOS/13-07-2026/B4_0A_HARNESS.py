#!/usr/bin/env python3
"""
B4_0A_HARNESS.py  (v4 -- post-auditoria 4)  -- Levanta un PostgreSQL REAL y lo deja en el estado de
TEST justo ANTES de B4-0A. Base para B4_0A_SMOKES.py, el VERIFY y el ROLLBACK.
...
Uso:  python3 B4_0A_HARNESS.py [--reset]
"""
import os
import sys
...
SQL_B4   = SCRIPT_DIR / 'B4_0A_ROL_TABLAS_FUNCIONES.sql'
...
def main():
    ...
    print('  B4_0A_ROL_TABLAS_FUNCIONES.sql: EJECUTADO OK (fingerprint adaptado al harness)')
