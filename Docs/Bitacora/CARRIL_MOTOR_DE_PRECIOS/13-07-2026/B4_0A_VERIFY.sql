-- ============================================================================
-- B4_0A_VERIFY.sql   (v4 -- post-auditoria 4)
...
INSERT INTO _v SELECT 12, 'B02_columnas_total', '22', COUNT(*)::TEXT, COUNT(*) = 22
FROM _cols_real;
...
INSERT INTO _v SELECT 14, 'B04_constraints_total', '14', COUNT(*)::TEXT, COUNT(*) = 14
FROM _con_real;
...
INSERT INTO _fn_esp VALUES
 ...
 ('precios_api.api_precios_nonce_consumir(text,uuid)',                                 'v', false, NULL),
