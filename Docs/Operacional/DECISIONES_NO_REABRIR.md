...
> **Nota de numeración.** Las decisiones **D-C-64…70 están bloqueadas en `A10MP_CIERRE.md`** (A10-MP); su propagación a este ledger queda como **deuda propia del cierre de A10-MP**, no de esta etapa. Por eso este cierre arranca en **D-C-71** (no se reabren ni se renumeran las 64…70).
