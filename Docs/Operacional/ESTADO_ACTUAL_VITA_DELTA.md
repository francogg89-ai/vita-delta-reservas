...
**Schema canónico vigente:** `6B_SCHEMA_SQL.md v1.8.0` — incorpora el **Carril B** como capa real (sección 24 conceptual + PARTE C ejecutable), promovido a OPS en junio 2026 (ver `PROMOCION_CARRIL_B_OPS_CIERRE.md`). El núcleo refleja el estado real de DEV post-hardening (6D) y post-correcciones pre-TEST/pre-OPS (7A). DEV está alineado funcionalmente con la base v1.7.3 y **se reconstruirá desde v1.8.0** (ver `Pendiente_pre_produccion.md`).
...
- `6B_SCHEMA_SQL.md v1.8.0` — schema canónico SQL vigente (incorpora el Carril B como capa real). Backups históricos archivados.
